...
use docflow\base\ModuleRecord;

/**
 * This is an extension of the \yii\db\ActiveRecord class which implements method [[saveMultiple()]].
 * It allows saving of multiple [[ActiveRecord]] instances in one query. It works only for PostgreSql.
 */
class MultipleActiveRecord extends ModuleRecord
{
    /**
